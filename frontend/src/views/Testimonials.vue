<template>
  <section id="testimonials" class="testimonials">
    <div class="container">
      ...
      <p v-if="submissionMessage" class="submission-message" v-html="submissionMessage"></p>
...
const submitTestimonial = async () => {
  try {
    ...
    submissionMessage.value = "Thank you! Your comment is awaiting approval.<br>Merci ! Votre commentaire est en attente d'approbation.";
